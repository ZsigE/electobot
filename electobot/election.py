...
class Election(object):
    ...
    def prepare_predicted_support(self, support_dict):
        ...
        for party in support_dict.keys():
            if support_dict[party] == 0:
                del support_dict[party]
            else:
                # Express the support as a ratio, not a percentage - this makes
                # the maths much easier.
                support_dict[party] = (support_dict[party] / 100)
        
        # Fill in "Other" support automatically, to guarantee the support adds up
        # to 100.
        support_dict[OTH] = (1 - sum(support_dict.values()))
